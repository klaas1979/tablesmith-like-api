...
function peg$parse(input, options) {
  ...
  var peg$f1 = function(name, attributes) {
    if (name == 'br') return '\n';
  };
  var peg$f2 = function(name, attributes) { return name; };
  ...
  var peg$f13 = function(d) { return d.join(''); };
  var peg$f14 = function() { '\0' };
  var peg$f15 = function() { throw new SyntaxError ['string data'], 'octal escape sequence', offset(), line(), column() };
  var peg$f16 = function() { '\b' };
  var peg$f17 = function() { '\t' };
  var peg$f18 = function() { '\n' };
  var peg$f19 = function() { '\v' };
  var peg$f20 = function() { '\f' };
  var peg$f21 = function() { '\r' };
  var peg$f22 = function(c) { c };
